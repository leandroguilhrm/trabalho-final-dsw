...
class ConsultaSalaAvaliacao extends Component {
    constructor(props){
        super(props);
        this.state = {
            id:   '',
    ...
    componentDidMount(){
        ...
        this.el.DataTable({
            ...
            columns: [
                ...
                {title: "Competição", data: "hair_color"},
                {
        ...
        this.el.on( 'click', '.btn-editar', function () {
            $(document.location).attr('href', '/salas-avaliacao/cadastro/' + $(this).parent().parent().children().first().text());
        } );
    }
                            ...
                            <div className={'col-sm-12'}>
                                <div className={'card'}>
                                    <div className={'card-header'}>
                                        <i className={'fa fa-table'}></i> Salas de Avaliação</div>
...
export default ConsultaSalaAvaliacao;

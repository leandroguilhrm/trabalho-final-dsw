...
class ConsultaCriterio extends Component {
    constructor(props){
        super(props);
        this.state = {
            id:   '',
    ...
    componentDidMount(){
        ...
        this.el.on( 'click', '.btn-editar', function () {
            $(document.location).attr('href', '/criterios/cadastro/' + $(this).parent().parent().children().first().text());
        } );
    }
                            ...
                            <div className={'col-sm-12'}>
                                <div className={'card'}>
                                    <div className={'card-header'}>
                                        <i className={'fa fa-table'}></i> Critérios</div>
...
export default ConsultaCriterio;

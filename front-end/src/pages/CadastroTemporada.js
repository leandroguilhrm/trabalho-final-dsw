...
class CadastroTemporada extends Component {
    constructor(props){
        super(props);
        this.state = {
            id: '',
            ...
            <div>
                ...
                <div className={'content-wrapper'}>
                    <div className={'container-fluid'}>
                        <div className={'row'}>
                            <div className={'col'}>
                                <h3 className={'page-header'}>Cadastro de Temporadas</h3>
                            </div>
                        </div>
                        <div className={'row'}>
...
export default CadastroTemporada;
